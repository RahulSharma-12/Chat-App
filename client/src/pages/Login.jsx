...
import { usernameValidator } from '../utils/validators';
 const Login = () => {
    const [isLogin , setIsLogin] = useState((prev) => !prev);
        ...
        > {isLogin ? ( <>
            <Typography variant='h5'>Login</Typography>
               ...
               >
                ...
                fullWidth
                variant = "text" onClick = {() =>setIsLogin(false)} >Sign Up Instead</Button>
                </form>  
            ...
            <Typography variant='h5'>Sign Up</Typography>
             ...
             
             {
                ...
                fullWidth
                variant = "text" onClick = {() =>setIsLogin(true)} >Login Instead</Button>
                </form>  
